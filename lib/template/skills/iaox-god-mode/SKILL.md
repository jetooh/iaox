...
- Save: `.aiox-core/development/agents/{name}.md` (core) or `squads/{squad}/agents/{name}.md` (squad)
...
- Save: `.aiox-core/development/tasks/{name}.md` (core) or `squads/{squad}/tasks/{name}.md` (squad)
...
- Save: `.aiox-core/development/workflows/{name}.yaml` (core) or `squads/{squad}/workflows/{name}.yaml`
...
└─ Framework ──→ @aiox-master (Orion)        /AIOX:agents:aiox-master
```
...
|-------|-----------|-------|
| **L1** Core | NEVER | `.aiox-core/core/`, `constitution.md`, `bin/` |
